...
suffixes = [ "f0", "f10", "f20", "f30", "f40", "f50" ]
mappings = [(0,1)]
host_cols = [[1]]
alphas = [ "a1" ]
BASE_DIR = "/home/ubuntu/correlations/continuous/synthetic/normal"
INDEX_DIR = "/home/ubuntu/correlations/paper/experiments/scalability/gaussian_noise/indexes"

corrix_mapping_file = lambda m, a, s: \
        os.path.join(BASE_DIR, f"gaussian_noise_{a}_{s}.k1.{m[0]}_{m[1]}.mapping")
corrix_outliers_file = lambda m, a, s: \
        os.path.join(BASE_DIR, f"gaussian_noise_{a}_{s}.k1.{m[0]}_{m[1]}.outliers")
corrix_targets_file = lambda m, a, s: \
        os.path.join(BASE_DIR, f"gaussian_noise_{a}_{s}.k1.{m[0]}_{m[1]}.targets")
